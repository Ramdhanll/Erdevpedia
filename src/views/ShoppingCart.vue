                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Pajak <span>10% ${{ totalHarga * 10 / 100 }}.00</span></li>
                                    <li class="subtotal mt-3">Total Pajak <span>${{totalPajak}}</span></li>
  ...
  components:{
    ...
    methods: {
      ...
      checkout(){
        ...
        localStorage.setItem('keranjangUser','null');
